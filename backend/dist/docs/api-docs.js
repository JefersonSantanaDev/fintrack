...
exports.setupApiDocumentation = setupApiDocumentation;
...
function setupApiDocumentation(app) {
    ...
    swagger_1.SwaggerModule.setup(API_DOCS_PATH, app, openApiDocument, {
    ...
    fastify.get(API_REDOC_PATH, (_request, reply) => {
        reply.type('text/html; charset=utf-8').send(redocHtml(API_DOCS_JSON_PATH));
    });
    fastify.get(API_SCALAR_PATH, (_request, reply) => {
